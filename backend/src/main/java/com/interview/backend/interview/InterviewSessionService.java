...
public class InterviewSessionService {
    ...
    public QuestionResponse generateQuestion(String userEmail, Long sessionId) {
        ...
        String context = projectFileRepository.findByProjectId(session.getProjectId()).stream()
        ...
        Question question = new Question(sessionId, null, nextSequenceNo, questionText, "AI", null);
        questionRepository.save(question);
